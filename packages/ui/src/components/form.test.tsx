...
describe("UI Form Components", () => {
  ...
  describe("Select Component", () => {
    ...
    it("should handle multiple selections", async () => {
      const handleChange = vi.fn();
      render(<Select label="Fruits" options={options} multiple onChange={handleChange} />);
  ...
  describe("RadioGroup Component", () => {
    ...
    it("should handle selection", async () => {
      const handleChange = vi.fn();
      render(<RadioGroup label="Size" options={options} name="size" onChange={handleChange} />);
  ...
  describe("Accessibility", () => {
    it("should have proper ARIA attributes", () => {
      ...
      expect(input).toHaveAttribute("aria-describedby", "email-error email-help");
