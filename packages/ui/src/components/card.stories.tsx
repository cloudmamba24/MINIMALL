...
export const WithFooter: Story = {
  render: () => (
    <Card>
      ...
      <CardContent>
        <p>
          A great product that you'll love. Features include excellent quality and competitive
          pricing.
        </p>
      </CardContent>
      <CardFooter>
    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-3">
          <p>
            This is the main content area where you can put any content like text, images, or other
            components.
          </p>
...
export const ImageCard: Story = {
  render: () => (
    <Card className="overflow-hidden">
      ...
      <CardContent>
        <p>
          This card style works great for galleries, product showcases, or any content that benefits
          from a prominent visual element.
        </p>
      </CardContent>
    </Card>
  ),
    ...
    <Card className="cursor-pointer hover:shadow-lg transition-shadow">
      ...
      <CardContent>
        <p className="text-sm text-gray-600">
          This card serves as a clickable action item, perfect for dashboard shortcuts or
          navigation.
        </p>
      </CardContent>
    </Card>
    ...
    <div className="space-y-4" style={{ maxWidth: "none", width: "500px" }}>
      <Card className="border-l-4 border-l-blue-500 bg-blue-50">
        ...
        <CardContent className="text-blue-800">
          <p>
            This card uses custom styling to create a distinctive appearance with colored borders
            and backgrounds.
          </p>
        </CardContent>
      </Card>
