...
export function BrandHeader({ title, subtitle, logo, socialLinks, ctaButton }: BrandHeaderProps) {
  return (
    <div className="text-center mb-8 space-y-6">
      ...
      {/* Brand Title */}
      <div>
        <h1 className="text-white text-xl font-bold tracking-wide mb-2">{title}</h1>
      ...
      {ctaButton && (
        <a
          href={ctaButton.url}
          className="inline-block bg-transparent border border-white text-white px-8 py-3 text-sm font-medium tracking-wide hover:bg-white hover:text-black transition-colors duration-200"
        >
          {ctaButton.text}
        </a>
      )}
