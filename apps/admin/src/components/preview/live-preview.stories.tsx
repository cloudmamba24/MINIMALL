...
const meta: Meta<typeof LivePreview> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Real-time preview system that displays site configurations across multiple viewports with live updates via postMessage communication. Features responsive design testing and cross-origin iframe communication.",
      },
    },
  },
  tags: ["autodocs"],
...
export const PreviewFeatures: Story = {
      ...
      <div style={{ padding: "1rem" }}>
        ...
        >
          ...
          <p style={{ margin: 0, fontSize: "14px", color: "#92400e" }}>
            The Live Preview system uses iframe sandboxing with postMessage API for secure
            cross-origin communication. It provides real-time updates between the admin interface
            (port 3001) and public preview (port 3000), with responsive viewport simulation and
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Comprehensive overview of the Live Preview system's features and technical implementation.",
      },
    },
  },
};
