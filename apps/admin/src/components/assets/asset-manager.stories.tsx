...
const meta: Meta<typeof AssetManager> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A comprehensive asset management system with drag-and-drop uploads, filtering, search, and cloud storage integration. Supports images, videos, and documents with metadata management.",
      },
    },
  },
  tags: ["autodocs"],
...
export const EmptyState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "The asset manager in its empty state, showing the upload drop zone and empty message.",
      },
    },
  },
};
...
export const WithManyAssets: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Asset manager with a large collection of assets demonstrating pagination, search, and filtering capabilities.",
      },
    },
  },
};
...
export const InteractiveDemo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Fully interactive asset manager demonstrating real-time updates, file uploads, and asset management operations.",
      },
    },
  },
};
