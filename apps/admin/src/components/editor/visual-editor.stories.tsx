...
const meta: Meta<typeof VisualEditor> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A drag-and-drop visual editor for creating and managing link-in-bio site configurations. Supports multiple content types and real-time preview updates.",
      },
    },
  },
  tags: ["autodocs"],
...
export const EmptyState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "The editor in its empty state, showing the component palette and empty content area.",
      },
    },
  },
};
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "An interactive version of the editor that responds to changes and updates the config in real-time.",
      },
    },
  },
};
          ...
          {[
            {
              type: "image",
              label: "Image",
              description: "Add photos, artwork, or graphics",
              color: "#e3f2fd",
            },
            {
              type: "video",
              label: "Video",
              description: "Embed videos or clips",
              color: "#f3e5f5",
            },
            {
              type: "product",
              label: "Product",
              description: "Showcase products from your shop",
              color: "#e8f5e8",
            },
            {
              type: "text",
              label: "Text",
              description: "Add headings, descriptions, or links",
              color: "#fff3e0",
            },
            {
              type: "link",
              label: "Link",
              description: "External links and CTAs",
              color: "#fce4ec",
            },
            {
              type: "social",
